...
ensure_atom(Term) when is_atom(Term)   -> Term;
ensure_atom(Term) when is_binary(Term) -> binary_to_atom(Term, utf8);
ensure_atom(Term) when is_list(Term)   -> list_to_atom(Term).
